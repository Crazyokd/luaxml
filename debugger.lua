...
local function mutate_bindings(_, name, value)
    ...
    do
        local i = 1; repeat
            ...
            if name == var then
                ...
                "debugger.lua" .. GREEN_CARET .. "Set local variable " .. COLOR_BLUE .. name .. COLOR_RESET)
    ...
    do
        local i = 1; repeat
            ...
            if name == var then
                dbg_writeln(COLOR_YELLOW .. "debugger.lua" .. GREEN_CARET ..
    ...
    -- Set a global.
    dbg_writeln(COLOR_YELLOW .. "debugger.lua" .. GREEN_CARET .. "Set global variable " .. COLOR_BLUE ..
    name .. COLOR_RESET)
    _G[name] = value
end
...
local function cmd_help()
    dbg.write(""
        ...
        .. COLOR_BLUE ..
        "  n" .. COLOR_YELLOW .. "(ext)" .. GREEN_CARET .. "step forward by one line (skipping over functions)\n"
        .. COLOR_BLUE .. "  f" ..
        COLOR_YELLOW .. "(inish)" .. GREEN_CARET .. "step forward until exiting the current function\n"
        ...
        .. COLOR_BLUE ..
        "  i" .. COLOR_YELLOW .. "(nspect) " .. COLOR_BLUE .. "[index]" ..
        GREEN_CARET .. "move to a specific stack frame\n"
        ..
        COLOR_BLUE ..
        "  w" ..
        COLOR_YELLOW .. "(here) " ..
        COLOR_BLUE .. "[line count]" .. GREEN_CARET .. "print source code around the current line\n"
        .. COLOR_BLUE .. "  e" ..
        COLOR_YELLOW .. "(val) " .. COLOR_BLUE .. "[statement]" .. GREEN_CARET .. "execute the statement\n"
        ..
        COLOR_BLUE ..
        "  p" ..
        COLOR_YELLOW ..
